...
GTimer GPSReadTimer(MS);  //таймер для чтения GPS с порта
...
#define SMSReadTimerPeriod 10000 //каждые 10 секунд прочитать смс
byte msgIndex = 1; //переменная для храния индекса последнего прочитанного СМС
